#!/usr/bin/env bash
# GBS256 launcher for Qwen3.5 full-tuning SFT on the local 8x H200 node.
#
# Experiment profile:
...
export RUN_PREFIX=${RUN_PREFIX:-qwen35_9b_official_tool_h200_sft_full_freeze_gbs256_tok32k}
