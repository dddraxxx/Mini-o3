#!/usr/bin/env bash
# Frozen launcher for the Qwen3.5 T12 no-exceed-mask ablation.
#
# Experiment profile:
...
# - actor lr: 1e-6
# - no exceed masking: MINIO3_IGNORE_EXCEED=False
...
export RUN_PREFIX=${RUN_PREFIX:-qwen35_9b_official_tool_h200_rl_t12_no_exceed_mask_100step}
