...
MINIO3_IGNORE_CLIP=${MINIO3_IGNORE_CLIP:-False}
MINIO3_IGNORE_EXCEED=${MINIO3_IGNORE_EXCEED:-True}
MINIO3_IGNORE_FORMAT=${MINIO3_IGNORE_FORMAT:-False}
MINIO3_IGNORE_INVALID=${MINIO3_IGNORE_INVALID:-False}
...
ACTOR=(
    ...
    actor_rollout_ref.actor.ignore_clip=${MINIO3_IGNORE_CLIP}
    actor_rollout_ref.actor.ignore_exceed=${MINIO3_IGNORE_EXCEED}
    actor_rollout_ref.actor.ignore_format=${MINIO3_IGNORE_FORMAT}
    actor_rollout_ref.actor.ignore_invalid=${MINIO3_IGNORE_INVALID}
