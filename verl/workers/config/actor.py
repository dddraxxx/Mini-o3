...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        ignore_clip (bool): Whether to zero actor loss masks for Mini-o3 trajectories that fill response length.
        ignore_exceed (bool): Whether to zero actor loss masks for Mini-o3 trajectories that exceed turn/tool budgets.
        ignore_format (bool): Whether to zero actor loss masks for Mini-o3 terminal trajectories without final answers.
        ignore_invalid (bool): Whether to zero actor loss masks for any Mini-o3 invalid trajectory.
